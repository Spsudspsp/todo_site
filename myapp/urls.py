...
urlpatterns = [
    ...
    path('profile/image', login_required(SetProfileImageView.as_view()), name='set pfp'),
    path('logout', login_required(LogoutView.as_view()), name='logout'),
    path('profile/delete', login_required(DeleteProfileView.as_view()), name='delete profile')
